...
<head>
    <title>Condat - Work Smart, Work Fast</title>
    <!-- Meta -->
    <meta charset="utf-8">
    ...
    <!-- Plugins CSS -->
    <link rel="stylesheet" href="{{asset('asset/plugins/font-awesome/css/font-awesome.css')}}">
    <link rel="stylesheet" href="{{asset('asset/plugins/flexslider/flexslider.css')}}">
    <!-- Theme CSS -->
    <link id="theme-style" rel="stylesheet" href="{{asset('asset/css/styles.css')}}">
...
<footer class="footer">
            ...
            <div class="row">
                ...
                <div class="footer-col connect col-md-6 col-sm-12 col-xs-12">
                    <div class="footer-col-inner">
                        ...
                        <p class="tel"><i class="fa fa-phone"></i>  61 430807730</p>
                        <p class="email"><i class="fa fa-envelope-o"></i>  <a href="mailto:support@condat.com.au"> support@condat.com.au</a></p>
    ...
    <div class="bottom-bar">
        <div class="container">
            <small class="copyright">Copyright @ <a href="https://www.condat.com.au/">Condat Solutions</a> 2016</small>
        </div><!--//container-->
    </div><!--//bottom-bar-->
</footer>
</body>
