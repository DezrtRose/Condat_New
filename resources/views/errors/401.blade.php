...
@section('title', 'Condat - 401 Page')
@section('heading', 'Condat - 401 Page')
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="error-page">
                        ...
                        <div class="error-content text-white" style="padding: 15px;">
                            ...
                            <p>
                                You are not authorized to access the page you're trying to reach.
                                {{--<br/>Please upgrade to <strong>Standard Subscription</strong> to access all the functions.--}}
