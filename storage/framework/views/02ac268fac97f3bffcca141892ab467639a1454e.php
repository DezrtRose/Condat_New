<?php $__env->startSection('title', 'Application Offer Letter Received'); ?>
<?php $__env->startSection('heading', '<h1>' . $client_name . '- <small>Offer Letter Received</small></h1>'); ?>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <?php echo e($application->course_name); ?>
                ...
                <div class="form-group">
                    <?php echo Form::label('intake_id', 'Select Intake', ['class'=>'col-md-3 form-label text-right']); ?>
                    ...
                    <div class="col-md-8">
                        ...
                        <a class="btn btn-success btn-xs marginTop" data-toggle="modal" data-target="#condat-modal"
                           data-url="<?php echo e(url('tenant/application/intake/add')); ?>"><i
                ...
                <div class="form-group <?php if($errors->has('student_id')): ?> <?php echo e('has-error'); ?> <?php endif; ?>">
                    <?php echo e(Form::label('student_id', 'Student Id', ['class'=>'col-md-3 form-label text-right'])); ?>

                    <div class="col-md-8">
                        <?php echo e(Form::text('student_id', null, ['class'=>'form-control col-md-12','placeholder'=>'Student ID'])); ?>
                ...
                <div class="form-group <?php if($errors->has('fee_for_coe')): ?> <?php echo e('has-error'); ?> <?php endif; ?>">
                    <?php echo e(Form::label('fee_for_coe', 'Total Fee For COE', ['class'=>'col-md-3 form-label text-right'])); ?>
                ...
                <div class="form-group <?php if($errors->has('description')): ?> <?php echo e('has-error'); ?> <?php endif; ?>">
                    <?php echo e(Form::label('description', 'Notes', ['class'=>'col-md-3 form-label text-right'])); ?>
