				...
				<tr>
					<td width="100%">
							...
							<tr>
								...
								<td width="100%" bgcolor="#33a0d5">
								 <h1 style="font-size:38px;color:#ffffff;text-transform:uppercase;text-align:center;margin:0;line-height: 1;">
                                        <?php echo e($heading); ?> </h1>
                                  <p style="color: #fff; text-align:center; display: block;font-size: 14px;font-weight: normal;letter-spacing: 1.5px;text-transform: none;"><?php echo e($subheading); ?></p>
						...
						<div style="text-align: center">
                            <p style="font-size: 14px; color: #7a7a7a; text-align: center; line-height: 24px;">&copy; Copyrights <?php echo e(date('Y')); ?>  | <a href="<?php echo e(URL('/')); ?>"><?php echo e($heading); ?></a></p>
                        </div>
