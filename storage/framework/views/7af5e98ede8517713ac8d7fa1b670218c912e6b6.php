    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <?php echo $__env->make('flash::message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
             <?php echo Form::model($payment, array('route' => array('application.students.updatePayment', $payment->student_payments_id), 'class' => 'form-horizontal form-left', 'method' => 'put')); ?>
