<div class="box-body">
    <div class="col-md-6">
        ...
        <div class="form-group">
            <?php echo Form::label('application_id', 'Application *', array('class' => 'col-sm-4 control-label')); ?>

            <div class="col-sm-8">
                <?php echo Form::select('application_id', $applications, null, array('class' => 'form-control', 'id'=>'application_id')); ?>
        ...
        <div class="form-group <?php if($errors->has('invoice_amount')): ?> <?php echo e('has-error'); ?> <?php endif; ?>">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                    <?php echo Form::text('invoice_amount', null, array('class' => 'form-control', 'id'=>'invoice_amount','autocomplete'=>'off')); ?>
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    ...
                    <span class="input-group-addon">
                               <?php echo e(Form::checkbox('gst_checker_incentive', 'incentive', false,array('id'=>'gst_checker_incentive'))); ?> GST
                            </span>
                </div>
