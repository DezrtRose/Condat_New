...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <?php echo Form::model($payment, array('route' => array('application.subagents.updatePayment', $payment->subagent_payments_id), 'class' => 'form-horizontal form-left', 'method' => 'put')); ?>
