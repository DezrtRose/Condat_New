<?php $__env->startSection('title', 'Application COE Processing'); ?>
<?php $__env->startSection('heading', '<h1>Application - <small>COE Processing</small></h1>'); ?>
                ...
                <table class="table table-striped table-bordered table-condensed" id="coe_table">
                    ...
                    <?php foreach($applications as $application): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('applications.action.coe.issued',[$application->course_application_id])); ?>"
