<?php $__env->startSection('title', 'Institute Documents'); ?>
<?php $__env->startSection('heading', 'Institute Documents'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    @parent
    <li><a href="<?php echo e(url('client')); ?>" title="All Institutes"><i class="fa fa-building"></i> Institutes</a></li>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-xs-12 mainContainer">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <?php echo Form::open(['files' => true, 'method' => 'post','class' => 'form-left']); ?>

                <div class="col-xs-12">
                    <div class="form-group <?php if($errors->has('type')): ?> <?php echo e('has-error'); ?> <?php endif; ?>">
                        <?php echo Form::label('type', 'Document Type *', array('class' => 'control-label')); ?>
                    ...
                    <div class="form-group <?php if($errors->has('document')): ?> <?php echo e('has-error'); ?> <?php endif; ?>">
                        <?php echo Form::label('document', 'File *', array('class' => 'control-label')); ?>
