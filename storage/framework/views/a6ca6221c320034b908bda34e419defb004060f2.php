...
<?php $__env->startSection('heading', '<h1>Application - <small>Enquiry</small></h1>'); ?>
                ...
                <table class="table table-striped table-bordered table-condensed" id="application_table">
                    ...
                    <?php foreach($applications as $application): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('applications.apply.offer',[$application->course_application_id])); ?>"
                                ...
                                <a href="<?php echo e(route('applications.cancel.application',[$application->course_application_id])); ?>"
