...
<?php $__env->startSection('heading', '<h1>' . $client_name . '- <small>Apply Offer</small></h1>'); ?>
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-7 col-md-offset-1">
                        <?php echo Form::model($application, ['class'=>'form-horizontal', 'method'=>'POST', 'route'=>['applications.apply.update', $application->application_id]]); ?>


                        <div class="form-group">
                            <?php echo e(Form::label('institute_name', 'Institute Name', ['class'=>'col-md-3 form-label text-right'])); ?>

                            <div class="col-md-9"><?php echo e($application->company_name); ?></div>
                        </div>

                        <div class="form-group">
                            <?php echo e(Form::label('course_name', 'Course Name', ['class'=>'col-md-3 form-label text-right'])); ?>

                            <div class="col-md-9"><?php echo e($application->course_name); ?></div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-9 col-md-offset-3">
                                <?php echo e(Form::submit('Apply Now',['class'=>'btn btn-primary'])); ?>
