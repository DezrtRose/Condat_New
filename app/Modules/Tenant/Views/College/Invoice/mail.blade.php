...
{!!Form::open(['id' => 'mail-invoice', 'class' => 'form-horizontal form-left'])!!}
...
<div class="modal-body">
    <div class="form-group">
        ...
        <div class="col-sm-8">
            {!!Form::select('to[]', $email_list, $company_email, array('class' => 'form-control email', 'id' => 'to', 'multiple' => 'multiple'))!!}
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-9 form-control-wrapper">
            <div data-id="body" data-widget="AutosizeTextarea" data-name="body" data-maxlength="10000"
                 data-autosize="false" data-rows="10" data-cols="50"><textarea rows="10" id="body" name="body"
                                                                               ...
                                                                               class="wys form-control">Dear <strong>{{ $invoice->company_name }}</strong>,

<p>We've attached invoice <strong>{{ format_id($invoice->invoice_id, 'I') }}</strong> for {{ format_price($invoice->final_total) }}. <br/>
Invoice date is {{ format_date($invoice->invoice_date) }}.</p>
