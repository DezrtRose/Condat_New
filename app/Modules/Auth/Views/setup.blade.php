        ...
        <div class="login-box-body">
            ...
            <form action="{{url('tenant/complete')}}" method="post">
                ...
                <div class="form-group has-feedback @if($errors->has('phone_id')) {{'has-error'}} @endif">
                    {!!Form::text('phone_id', null, array('class' => 'form-control', 'id'=>'phone_id', 'placeholder' => 'Phone Number *'))!!}
                    <span class="glyphicon glyphicon-user form-control-feedback"></span>
                ...
                <div class="form-group has-feedback @if($errors->has('street')) {{'has-error'}} @endif">
                    {!!Form::text('street', null, array('class' => 'form-control', 'id'=>'street', 'placeholder' => 'Street'))!!}
                    <span class="glyphicon glyphicon-user form-control-feedback"></span>
                ...
                <div class="form-group has-feedback @if($errors->has('suburb')) {{'has-error'}} @endif">
                    {!!Form::text('suburb', null, array('class' => 'form-control', 'id'=>'suburb', 'placeholder' => 'Suburb'))!!}
                    <span class="glyphicon glyphicon-user form-control-feedback"></span>
                ...
                <div class="form-group has-feedback @if($errors->has('postcode')) {{'has-error'}} @endif">
                    {!!Form::text('postcode', null, array('class' => 'form-control', 'id'=>'postcode', 'placeholder' => 'Postcode'))!!}
                    <span class="glyphicon glyphicon-user form-control-feedback"></span>
